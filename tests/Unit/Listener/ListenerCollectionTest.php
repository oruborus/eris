...
class ListenerCollectionTest extends TestCase
{
     ...
     * @test
     *
     * @covers Eris\Listener\ListenerCollection::__construct
     * @covers Eris\Listener\ListenerCollection::add
    ...
    public function listenersCanBeAddedAndAllTheirInterfaceMethodCanGetCalled(): void
    {
        ...
        $dut = new ListenerCollection([$listener1]);
        $dut->add($listener2);
     ...
     *
     * @uses Eris\Listener\ListenerCollection::__construct
