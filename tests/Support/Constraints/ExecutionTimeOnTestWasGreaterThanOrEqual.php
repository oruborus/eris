...
class ExecutionTimeOnTestWasGreaterThanOrEqual extends TestSuiteConstraint
{
    ...
    {
        return "was executed in greater than or equal to {$this->time} second" . ($this->time === 1.0 ? '' : 's');
    }
